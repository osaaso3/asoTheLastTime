...
namespace TheLastTime.Shared.Data
{
    ...
    public class DataService : INotifyPropertyChanged
    {
        ...
        public async Task LoadData()
        {
            ...
            {
                db.Categories.Add(new Category() { Id = 1, Description = "Default" });
                save = true;
            }
        ...
        public async Task SaveCategory(Category category)
        {
            ...
            else if (db.Categories.SingleOrDefault(c => c.Id == category.Id) is Category dbCategory)
            {
                ...
                dbCategory.CongRatio = category.CongRatio;
                dbCategory.N = category.N;
                dbCategory.durFix = category.durFix;
                dbCategory.durPrime = category.durPrime;
                dbCategory.durMask = category.durMask;
                dbCategory.durTarget = category.durTarget;
